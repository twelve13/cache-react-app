...
const caroline = new User({name: "Caroline", current_funds: 100, source: "paycheck", accounts: [mortgage, food, pets]});
const whitney = new User({name: "Whitney", current_funds: 50, source: "paycheck", accounts: [car, fun]});
